...
const SvgRecieveMoney = ({
  ...
  >
    ...
    <g
      ...
      strokeWidth={1.5}
      clipPath="url(#Recieve-Money_svg__a)"
    >
      <path d="M3 15.15h6.11M7.22 12.98l2.01 2.01c.08.08.08.22 0 .31l-2.01 2.01" />
    ...
    <defs>
      <clipPath id="Recieve-Money_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgRecieveMoney;
