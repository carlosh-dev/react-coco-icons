...
const SvgRemoveCamera = ({
  ...
  >
    ...
    <g
      ...
      strokeWidth={1.5}
      clipPath="url(#Remove-Camera_svg__a)"
    >
      ...
      <path d="M12 17.86a4.73 4.73 0 1 0 0-9.46 4.73 4.73 0 0 0 0 9.46ZM13.8 13.12l-3.6.01" />
    </g>
    <defs>
      <clipPath id="Remove-Camera_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgRemoveCamera;
